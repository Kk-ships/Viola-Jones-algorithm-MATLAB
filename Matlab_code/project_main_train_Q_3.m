...
for iterations = 1:Boosting_rounds
                    ...
                    for haarY = dimY:dimY:window-pixelY
                        ...
                        for iter = 1:100
                            ...
                            if faceRating < 0.10 % if less than 10% faces misclassified %find the best 10 percent of features of features
                                ...
                                if faceRating < 0.03 % if less than 3% faces are recognized wrongly(probability of prediction better than 50%)
    ...
    filename1 = sprintf('finalClassifiers_rounds_%02d_Q3.mat', iterations);
    save(filename1, 'selectedClassifiers_top', '-mat', '-v7.3');
    filename2 = sprintf('full_rounds_%02d_Q3.mat', iterations);
    save(filename2, '-mat', '-v7.3');
    filename3 = sprintf('trainedClassifiers_rounds_%02d_Q3.mat', iterations);
