...
for rounds = 1:Boosting_rounds
    ...
    %Lading data
    filename = sprintf('trainedClassifiers_rounds_%02d_Q3.mat', rounds);
    load (filename)
...
save('test_data_Q3.mat','false_positive','false_negative','face_eror','non_face_error','total_accuracy');
plot(total_accuracy)
hold on
plot(face_eror)
hold on
